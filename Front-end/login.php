...
<div class="cont">
    <div class="form sign-in">
      ...
      <form method="post" action="login.php" id="sign_in_form">
        ...
        <label id="email">
          <span>Email</span>
          <input type="email" name="email" id="signin_email" placeholder="abc@gmail.com" required pattern="(.+@gmail.com)" title="Please enter the correct email " /><br>
        </label>
        <label>
          <span>Password</span>
  ...
  <div class="sub-cont">
    ...
    <div class="form sign-up">
      ...
      <form method="post" action="login.php" id="register_form">
          <label>
          <span>Name</span>
            <input type="text" name="name" id="fullname"  pattern=".{3,}" required title="min character is 3" placeholder="Diksha" required><br>
        </label>     
        <label>
          <span>Email</span>
            <input type="email" name="email" id="signup_email" placeholder="abc@gmail.com" required pattern="(.+@gmail.com)"
            title="Please enter the correct email "><br>
        </label>
        <label>
          <span>Password</span>
          <input type="password" name="password_1" id="signup_password" pattern=".{5,15}" requirlled title="5 to 15 characters" placeholder="**********" > <br>
        </label>
